        ...
        public:
            ...
            double Evaluate(const SheetInterface& sheet) const override {
                ...
                struct FormulaInterFaceValue {
                    ...
                    void operator()(const std::string value) { throw FormulaError(FormulaError::Category::Value); }
                    void operator()(const FormulaError& fe) { throw FormulaError(FormulaError::Category::Div0); }
                ...
                if (sheet.GetCell(*cell_) != nullptr) {
                    ...
                    std::visit(v, sheet.GetCell(*cell_)->GetValue());
